...
var app = (function () {
    ...
    function create_if_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$2, 185, 23, 4777);
    		},
    		m: function mount(target, anchor) {
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "is-error svelte-imex1w");
    			add_location(div, file$2, 201, 22, 5243);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    // (236:8) {#if isErrorMonth || isErrorYear || isErrorCvc}
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$2, 236, 10, 6258);
    			attr_dev(div1, "class", "is-error svelte-imex1w");
    			add_location(div1, file$2, 239, 10, 6354);
    		},
    		m: function mount(target, anchor) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(236:8) {#if isErrorMonth || isErrorYear || isErrorCvc}",
    		ctx
    	});
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(label0, file$2, 176, 6, 4498);
    			...
    			add_location(input0, file$2, 177, 6, 4549);
    			attr_dev(div0, "class", "input-group");
    			add_location(div0, file$2, 175, 4, 4465);
    			attr_dev(label1, "for", "c-number");
    			attr_dev(label1, "class", "svelte-imex1w");
    			add_location(label1, file$2, 190, 6, 4897);
    			...
    			add_location(input2, file$2, 209, 8, 5511);
    			...
    			add_location(input3, file$2, 217, 8, 5720);
    			...
    			add_location(input4, file$2, 226, 8, 5965);
    			attr_dev(div2, "class", "grid-group svelte-imex1w");
    			add_location(div2, file$2, 206, 6, 5362);
    			attr_dev(div3, "class", "input-group");
    			add_location(div3, file$2, 205, 4, 5329);
    			attr_dev(button, "class", "svelte-imex1w");
    			add_location(button, file$2, 245, 4, 6468);
    			attr_dev(form, "class", "svelte-imex1w");
    			add_location(form, file$2, 174, 2, 4453);
    			attr_dev(div4, "class", "container");
    			add_location(div4, file$2, 173, 0, 4426);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(input3, "blur", /*IsValidExpiration*/ ctx[17], false, false, false),
    					listen_dev(input4, "input", /*input4_input_handler*/ ctx[24]),
    					listen_dev(input4, "blur", /*IsValidCvc*/ ctx[18], false, false, false),
    					listen_dev(button, "click", prevent_default(/*handleConfirm*/ ctx[19]), false, true, false)
    				];
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	let $cardStore;
    	validate_store(cardStore, 'cardStore');
    	component_subscribe($$self, cardStore, $$value => $$invalidate(25, $cardStore = $$value));
    	let { $$slots: slots = {}, $$scope } = $$props;
    	...
    	const IsValidData = () => {
    		if (IsValidName() && IsValidCreditCard() && IsValidExpiration() && IsValidCvc()) return true; else return false;
    	};
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-16ehjg3");
    			add_location(img, file$1, 4, 2, 50);
    			attr_dev(h2, "class", "svelte-16ehjg3");
    			add_location(h2, file$1, 5, 2, 110);
    			attr_dev(p, "class", "svelte-16ehjg3");
    			add_location(p, file$1, 6, 2, 133);
    			attr_dev(button, "class", "svelte-16ehjg3");
    			add_location(button, file$1, 7, 2, 173);
    			attr_dev(div, "class", "container svelte-16ehjg3");
